  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ url(vendor().'vendor') }}" class="nav-link">Home</a>
      </li>
     <!--  <li class="nav-item d-none d-sm-inline-block">
...
<!-- 
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a class="brand-link text-center text-white">
      <!-- <img src="{{ url('admin_assets/dist/img/AdminLTELogo.png') }}" class="brand-image img-circle elevation-3" style="opacity: .8"> -->
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="{{url(vendor().'profile')}}" class="d-block">Vendor</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview {{ (request()->segment(2) == 'vendor') ? 'menu-open' : '' }}">
            <a href="{{ url(vendor().'vendor') }}" class="nav-link {{ (request()->segment(2) == 'vendor') ? 'active' : '' }} ">
          ...
          <!-- <li class="nav-item has-treeview {{ (request()->segment(2) == 'categories') ? 'menu-open' : '' }}">
            ...
            <li class="nav-item has-treeview {{ (request()->segment(3) == 'product') ? 'menu-open' : '' }}">
            <a href="{{ url(vendor().'product/list') }}" class="nav-link {{ (request()->segment(2) == 'product') ? 'active' : '' }} ">
              <i class="nav-icon fas fa-box"></i>
              <p>
                Product 
                <!-- <i class="right fas fa-angle-left"></i> -->
          ...
          <li class="nav-item has-treeview {{ (request()->segment(3) == 'order') ? 'menu-open' : '' }}">
            <a href="{{ url(vendor().'order') }}" class="nav-link {{ (request()->segment(2) == 'order') ? 'active' : '' }} ">
              ...
              @if(!vendor_id_to_order_count(user_data()->id) == 0)
                <span class="right badge bg-danger">{{vendor_id_to_order_count(user_data()->id)}}</span>
                @endif
            </a>
...
<!--           <li class="nav-item has-treeview {{ (request()->segment(1) == 'product') ? 'menu-open' : '' }}">
           ...
           <li class="nav-item has-treeview {{ (request()->segment(3) == 'profile') ? 'menu-open' : '' }}">
            <a href="{{ url(vendor().'profile') }}" class="nav-link {{ (request()->segment(2) == 'profile') ? 'active' : '' }} ">
