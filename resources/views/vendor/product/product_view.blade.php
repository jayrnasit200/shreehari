@extends('layouts.vendor') @section('css') @endsection @section('content') @include('title.heading')
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="col-12">
                                <img src="{{ url($products->image) }}" class="product-image img-fluid" alt="Product Image" />
                            </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <h3 class="my-3">{{ $products->name }} @if($products->verify=='Yes')<i class="fas fa-check-circle text-success"></i>@endif</h3>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="tab-content p-3" id="nav-tabContent">
                            <div class="tab-pane fade" id="product-comments" role="tabpanel" aria-labelledby="product-comments-tab">
                                Vivamus rhoncus nisl sed venenatis luctus. Sed condimentum risus ut tortor feugiat laoreet. Suspendisse potenti. Donec et finibus sem, ut commodo lectus. Cras eget neque dignissim, placerat orci interdum,
                                venenatis odio. Nulla turpis elit, consequat eu eros ac, consectetur fringilla urna. Duis gravida ex pulvinar mauris ornare, eget porttitor enim vulputate.
                            </div>
