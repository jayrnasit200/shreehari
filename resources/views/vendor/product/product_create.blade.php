    ...
    <div class="container">
        <div class="col-md-6">
            <div class="card card-default">
                ...
                <form method="post" action="{{ url('product/type/add') }}">@csrf
                    <div class="card-body">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Types Name</label>
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" placeholder="Enter Types Name" />
