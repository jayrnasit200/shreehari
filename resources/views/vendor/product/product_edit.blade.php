...
<section class="content">
    <div >
      <form method="post" enctype="multipart/form-data"  action="{{ url(vendor().'product/update') }}">
        {{ csrf_field() }}
                ...
                <div class="tab-content" id="custom-tabs-three-tabContent">
                  ...
                  <div class="tab-pane fade" id="custom-tabs-three-settings" role="tabpanel" aria-labelledby="custom-tabs-three-settings-tab">
                      <div class="container">
                       ...
                       <form method="post" action="{{ url(vendor().'product/img/add') }}" enctype="multipart/form-data">@csrf
                                ...
                                <form method="post" action="{{ url(vendor().'product/img/delete') }}">@csrf
                                <table class="table">
                                  <tr>
