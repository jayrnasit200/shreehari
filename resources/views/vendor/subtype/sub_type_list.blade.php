        ...
        <div class="col-md-12">
            <div class="card card-default">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ url('product/type/sub_type/create',$id) }}" class="btn btn-primary">Add </a>
                </div>
                    <table id="example1" class="table  table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{url('product/type/sub_type_list/edit',$value->id)}}" class="btn btn-primary btn-sm">Edit</a>
                                    <a href="{{url('product/type/sub_type_list/delete',$value->id)}}" class="btn btn-sm btn-danger text-white">Delete</a>
