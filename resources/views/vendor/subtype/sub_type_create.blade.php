                ...
                <form method="post" action="{{ url('product/type/sub_type/add') }}">@csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="color" class="form-control @error('color') is-invalid @enderror" name="color"value="{{ old('color') }}" placeholder="Enter color"  value=" " >
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('size_type') is-invalid @enderror" name="size_type" value="{{ old('size_type') }}" placeholder="Enter Size Types" />
