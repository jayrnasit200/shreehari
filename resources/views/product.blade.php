            ...
            <div class="column-block">
                ...
                <div class="row latest-grid product-grid">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 product-grid-item">
                        <div class="product-thumb transition">
                            <div class="image product-imageblock">
                                <a href="#"><img src="{{url('front_assets/image/product/2product50x59.jpg')}}" alt="lorem ippsum dolor dummy" title="lorem ippsum dolor dummy" class="img-responsive" /></a>
                                <div class="button-group">
                                    <button type="button" class="wishlist" data-toggle="tooltip" title="" data-original-title="Add to Wish List"><i class="fa fa-heart-o"></i></button>
                                    <button type="button" class="addtocart-btn">Add to Cart</button>
                                    <button type="button" class="compare" data-toggle="tooltip" title="" data-original-title="Compare this Product"><i class="fa fa-exchange"></i></button>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 product-grid-item">
                        <div class="product-thumb transition">
                            <div class="image product-imageblock">
                                <a href="#"><img src="{{url('front_assets/image/product/3product50x59.jpg')}}" alt="lorem ippsum dolor dummy" title="lorem ippsum dolor dummy" class="img-responsive" /></a>
                                <div class="button-group">
                                    <button type="button" class="wishlist" data-toggle="tooltip" title="" data-original-title="Add to Wish List"><i class="fa fa-heart-o"></i></button>
                                    <button type="button" class="addtocart-btn">Add to Cart</button>
                                    <button type="button" class="compare" data-toggle="tooltip" title="" data-original-title="Compare this Product"><i class="fa fa-exchange"></i></button>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="thumbnails">
                        <div>
                            <a class="thumbnail" href="{{url('front_assets/image/product/product8.jpg')}}" title="lorem ippsum dolor dummy">
                                <img src="{{ url($pro->image) }}" title="lorem ippsum dolor dummy" alt="lorem ippsum dolor dummy" />
                            </a>
                        </div>
              ...
              <div class="item">
                <div class="image-additional"><a class="thumbnail  " href="{{url('front_assets/image/product/product4.jpg')}}" title="lorem ippsum dolor dummy"> <img src="{{url('front_assets/image/product/pro-4-220x294.jpg')}}" title="lorem ippsum dolor dummy" alt="lorem ippsum dolor dummy" /></a></div>
              </div>
              <div class="item">
                <div class="image-additional"><a class="thumbnail  " href="{{url('front_assets/image/product/product5.jpg')}}" title="lorem ippsum dolor dummy"> <img src="{{url('front_assets/image/product/pro-5-220x294.jpg')}}" title="lorem ippsum dolor dummy" alt="lorem ippsum dolor dummy" /></a></div>
              </div>
              <div class="item">
                <div class="image-additional"><a class="thumbnail  " href="{{url('front_assets/image/product/product6.jpg')}}" title="lorem ippsum dolor dummy"> <img src="{{url('front_assets/image/product/pro-6-220x294.jpg')}}" title="lorem ippsum dolor dummy" alt="lorem ippsum dolor dummy" /></a></div>
              </div>
                ...
                <div class="col-sm-6">
                    ...
                    <p class="product-desc">
                        More room to move. With 80GB or 160GB of storage and up to 40 hours of battery life, the new lorem ippsum dolor dummy lets you enjoy up to 40,000 songs or up to 200 hours of video or any combination wherever you go.
                                ...
                                <div class="item">
                                    <div class="product-thumb transition">
                                        <div class="image product-imageblock">
                                            <a href="#">
                                                <img
                                                    src="{{url('front_assets/image/product/pro-1-220x294.jpg')}}"
                                ...
                                <div class="item">
                                    <div class="product-thumb transition">
                                        <div class="image product-imageblock">
                                            <a href="#">
                                                <img
                                                    src="{{url('front_assets/image/product/pro-2-220x294.jpg')}}"
                                                    alt="women's New Wine is an alcoholic"
                                                    title="women's New Wine is an alcoholic"
                                                    class="img-responsive"
                                                />
                                ...
                                <div class="item">
                                    <div class="product-thumb transition">
                                        <div class="image product-imageblock">
                                            <a href="#">
                                                <img
                                                    src="{{url('front_assets/image/product/pro-3-220x294.jpg')}}"
                                                    alt="women's New Wine is an alcoholic"
                                                    title="women's New Wine is an alcoholic"
                                                    class="img-responsive"
                                                />
                                ...
                                <div class="item">
                                    <div class="product-thumb transition">
                                        <div class="image product-imageblock">
                                            <a href="#">
                                                <img
                                                    src="{{url('front_assets/image/product/pro-4-220x294.jpg')}}"
                                                    alt="women's New Wine is an alcoholic"
                                                    title="women's New Wine is an alcoholic"
                                                    class="img-responsive"
                                                />
                                ...
                                <div class="item">
                                    <div class="product-thumb transition">
                                        <div class="image product-imageblock">
                                            <a href="#">
                                                <img
                                                    src="{{url('front_assets/image/product/pro-5-220x294.jpg')}}"
                                                    alt="women's New Wine is an alcoholic"
                                                    title="women's New Wine is an alcoholic"
                                                    class="img-responsive"
                                                />
                                ...
                                <div class="item">
                                    <div class="product-thumb transition">
                                        <div class="image product-imageblock">
                                            <a href="#">
                                                <img
                                                    src="{{url('front_assets/image/product/pro-6-220x294.jpg')}}"
                                                    alt="women's New Wine is an alcoholic"
                                                    title="women's New Wine is an alcoholic"
                                                    class="img-responsive"
                                                />
                                ...
                                <div class="item">
                                    <div class="product-thumb transition">
                                        <div class="image product-imageblock">
                                            <a href="#">
                                                <img
                                                    src="{{url('front_assets/image/product/pro-7-220x294.jpg')}}"
                                                    alt="women's New Wine is an alcoholic"
                                                    title="women's New Wine is an alcoholic"
                                                    class="img-responsive"
                                                />
