    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card card-default">
                ...
                <form method="post" enctype="multipart/form-data" action="{{ url(admin().'banners/update') }}">@csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">Select Type</label>
                              <select name="type" class="form-control select2" style="width: 100%;" aria-hidden="true">
                                        ...
                                        <option value="banner" @if(old('type',$data->status) == 'banner') selected @endif>Banner</option>
                                        <option value="logo" @if(old('type',$data->status) == 'logo') selected @endif>Logo</option>
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">Image</label>
                             ...
                             <b>NOTE: Upload New Image to select an image .</b><br>
        ...
        <div class="col-md-5">
            <div class="card card-default">
               <img src="{{url($data->image)}}" id="preview" class="img-fluid img-thumbnail">
            </div>
        </div>
    </div>
</section>
