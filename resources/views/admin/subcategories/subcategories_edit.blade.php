    ...
    <div class="container">
        <div class="col-md-6">
            <div class="card card-default">
                ...
                <form method="post" action="{{ url(admin().'categories/subcategories/update') }}">@csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                           ...
                           <div class="form-group">
                            <label for="exampleInputEmail1">Subcategories Name</label>
                                    <input type="text" class="form-control  @error('name') is-invalid @enderror" name="name" placeholder="Enter Name" value="{{ old('name',$subcategory->name) }}">
